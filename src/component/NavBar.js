...
const NavBar = () => {
  return (
    <>
      <div className="flex flex-wrap py-4 sticky justify-between items-center bg-blue-600 text-white">
        ...
        <div className="flex flex-row gap-3 mr-10 font-medium">
          <button className="border-2 border-solid border-white rounded-md p-2">
            <Link to="/login">
